...
This project is a Text-to-Image Generator developed to generate images based on user-provided text prompts using concepts from Artificial Intelligence and Machine Learning.
